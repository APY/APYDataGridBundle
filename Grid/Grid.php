...
class Grid {
    ...
    private function fetchAndSaveGridData() {
        ...
        if ($aj = $this->getData(self::REQUEST_QUERY_AJAX, true, false)) {
            $this->setAjax($aj);
        }
    ...
    public function render($view, array $parameters = array(), Response $response = null) {
        if ($this->getAjax()) {
            return $this->container->get('templating')->renderResponse('SorienDataGridBundle::grid.html.twig', $parameters, $response);
        } else {
            return $this->container->get('templating')->renderResponse($view, $parameters, $response);
        }
    }
